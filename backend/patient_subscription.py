...
AI-усиления:
  ...
  plus  65 сомони    — безлимитный ассистент (fair-use), AI-разбор анализов
...
class TierSpec:
    ...
    ``assistant_daily`` — дневной кап ассистента. У платных это не «безлимит»
    буквально, а fair-use предохранитель: канон обещает безлимит, но без
    потолка один скрипт способен сжечь маржу тарифа за сутки. Пороги стоят
    заведомо выше живого использования (человек не задаёт 50 вопросов в день).
    """
